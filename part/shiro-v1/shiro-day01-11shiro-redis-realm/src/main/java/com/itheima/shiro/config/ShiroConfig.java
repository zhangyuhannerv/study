...
public class ShiroConfig {
    ...
    public ShiroDbRealm shiroDbRealm() {
        ShiroDbRealmImpl shiroDbRealm = new ShiroDbRealmImpl();
        return shiroDbRealm;
    }
