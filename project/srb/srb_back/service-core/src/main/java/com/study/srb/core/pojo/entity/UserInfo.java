...
public class UserInfo implements Serializable {
    public static final Integer STATUS_NORMAL = 1;// 用户锁定
    public static final Integer STATUS_LOCKED = 0;// 用户正常
    public static final String USER_AVATAR = "https://srb-file-zhangyuhan.oss-cn-qingdao.aliyuncs.com/avatar/%E3%83%9F%E3%82%AF.jpeg";
