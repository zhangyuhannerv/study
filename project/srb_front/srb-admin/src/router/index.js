...
export const constantRoutes = [
  ...
  },
  {
    ...
    // 当alwaysShow的值为false（默认）值时，当且仅当父节点下只有一个子节点时，不显示父节点
    // 当值为true时，任何时候都显示父节点和子节点
    alwaysShow: true,
    children: [
      {
        path: 'list',
        name: 'coreIntegralGradeList', // 每个路由节点name的名字不能相同
        component: () => import('@/views/core/integral-grade/list'), // 指向template组件
